...
H.is_nil = MiniTest.new_expectation(
  'value is nil',
  function(value)
    return value == nil
  end,
...
H.is_not_nil = MiniTest.new_expectation(
  'value is not nil',
  function(value)
    return value ~= nil
  end,
...
H.matches = MiniTest.new_expectation(
...
H.contains = MiniTest.new_expectation(
...
H.is_table = MiniTest.new_expectation(
  'value is table',
  function(value)
...
H.is_string = MiniTest.new_expectation(
  'value is string',
  function(value)
...
H.is_number = MiniTest.new_expectation(
  'value is number',
  function(value)
